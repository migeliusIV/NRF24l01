...
#define pin_btn_B 13   // <...> Не назначена
#define pin_btn_C 4   // Направление 2
#define pin_btn_D 7   // Выстрел
#define pin_btn_SM 11   // slow motion, на версиях младше 2022 поменяйте пины кнопок, которые будут снаружи пульта
#define pin_btn_FM 12   // forsage, кнопку не проверял
...
void setup() {
  ...
  radio.setChannel(0x65); // Обмен данными будет вестись на 16 канале (2,416 ГГц). Это объясняется тем, что каналы кодируются не в десятеричной системе счисления
